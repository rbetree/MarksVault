...
| V6.4 | 任务列表页面实现 | V6.3 | 待开始 |
| V6.5 | 任务创建/编辑表单 | V6.4 | 待开始 |
| V6.6 | 基于时间的触发器实现 (Alarms API) | V6.2 | 待开始 |
| V6.8 | 任务执行引擎核心（基础版） | V6.2, V6.6 | 待开始 |
| V6.9 | 常见任务操作实现: 书签备份 | V6.8, V3.2 | 待开始 |
| V6.13 | 任务启用/禁用功能 | V6.4, V6.8 | 待开始 |

#### 集合2: 增强触发器与操作
| ID | 任务描述 | 依赖 | 状态 |
|----|---------|-----|------|
| V6.7 | 基于事件的触发器实现 | V6.6 | 待开始 |
...
| V6.16 | 任务导入/导出功能 | V6.2, V6.15 | 待开始 |
